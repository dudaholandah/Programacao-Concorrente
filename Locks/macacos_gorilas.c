/**
 * Solucao Professor do Desafio:
 * 
 * Após testar o programa acima, crie agora uma nova verão do programa adicionando dois gorilas, 
 * um em cada morro. Como os gorilas são muito pesados, eles só poderão atravessar a ponte sozinhos.
**/
